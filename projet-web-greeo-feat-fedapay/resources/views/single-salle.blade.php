                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-24">
                        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
                            ...
                            <form  method="GET" action="{{ route('checkout') }}" class="space-y-4">
                                @csrf <!-- Ajoutez cette ligne dans le formulaire -->
                                <input type="hidden" name="salle_id" value="{{ $salles->id }}">
                                <input type="hidden" name="salle_name" value="{{ $salles->name }}">
                                <input type="hidden" name="salle_price" value="{{ $salles->price_per_hour }}">
                                <input type="hidden" name="salle_image" value="{{ $salles->image }}">
                                
                                <div>
                                    <label class="block text-sm font-medium mb-2">Date</label>
                                    <input type="date" name="date" required class="w-full px-4 py-2 border border-gray-300 rounded-lg" min="{{ date('Y-m-d') }}">
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium mb-2">Durée (heures)</label>
                                    <select name="duration" required class="w-full px-4 py-2 border border-gray-300 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="participants" min="1" max="{{ $salles->capacity }}" placeholder="Capacité max {{ $salles->capacity }} personnes" required 
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg">
                                </div>

                                <div class="pt-4">
                                    <button type="submit" class="w-full bg-primary text-white py-3 rounded-lg font-medium hover:bg-purple-800 transition-colors">
                                        Réserver maintenant
                                    </button>
                                </div>
                            </form>
