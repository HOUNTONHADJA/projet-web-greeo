    ...
    <div class="fixed left-0 top-0 h-full w-64 bg-primary text-white z-40">
        ...
        <nav class="mt-6">
            <div class="px-4">
                ...
                <div class="sidebar-nav-item px-4 py-3 cursor-pointer flex items-center gap-3 rounded-lg mx-2 mt-1" >
                    <div class="w-5 h-5 flex items-center justify-center">
                ...
                <div class="sidebar-nav-item px-4 py-3 cursor-pointer flex items-center gap-3 rounded-lg mx-2 mt-1" data-section="settings">
                    <div class="w-5 h-5 flex items-center justify-center">
